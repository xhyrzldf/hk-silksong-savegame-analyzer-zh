            ...
            {tools.map((item, index) => {
              ...
              return (
                <tr key={index} className="border-b border-gray-700 last:border-b-0">
                  ...
                  <td className="px-2 py-1 relative break-words whitespace-pre-line blur-sm hover:blur-none transition duration-100">
                    {item.location}
                  </td>
...
export function getToolsExtra({ parsedJson, decrypted }: { parsedJson: unknown; decrypted: boolean }): ReactNode {
  if (!decrypted || !parsedJson) {
    return null;
  }
