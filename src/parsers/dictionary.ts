...
export const CATEGORIES: CollectableCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Memory Locket 2', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Hunters March far right: In a cage at the end of the spiky corridor. Break the cage to loot it.', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478017' },
      { name: 'Memory Locket 3', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Greymoore: On a ledge above the Mitemother', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478035' },
      { name: 'Memory Locket 4', whichAct: 0, completionPercent: 0, prereqs: ['Faydown Cloak'], location: 'Greymoore: Inside Halfway Home', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478039' },
      ...
      { name: 'Memory Locket 6', whichAct: 3, completionPercent: 0, prereqs: ['Silk Soar'], location: 'Bellhart town: Silk Soar into the roof', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478212' },
      ...
      { name: 'Memory Locket 8', whichAct: 0, completionPercent: 0, prereqs: ['Cling Grip'], location: 'Top of the Marrows', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478246' },
      { name: 'Memory Locket 9', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Grand Bellway, behind a breakable wall above the bellway station', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478372' },
      { name: 'Memory Locket 10', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Wormways: Bottom right held by a corpse', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478493' },
      { name: 'Memory Locket 11', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Blasted Steps: On a narrow platform above the sands', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478502' },
      { name: 'Memory Locket 12', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Underworks: Found by jumping into the Passage, then dropping down a hole to the left', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478571' },
      { name: 'Memory Locket 13', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Bilewater: At the top of a tunnel', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478676' },
      { name: 'Memory Locket 14', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Bilewater: At the far left edge of a secret room. Bounce over the infested waters and wall-jump up the vertical space to reach it', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478787' },
      { name: 'Memory Locket 15', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Deep Docks: Held by a corpse at the bottom of a magma-filled area found behind the Breakable Wall', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478836' },
      { name: 'Memory Locket 16', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Bilewater: Held by a corpse in a breakable cocoon dangling from the ceiling', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478851' },
      { name: 'Memory Locket 17', whichAct: 0, completionPercent: 0, prereqs: [], location: 'The Slab: Inside the shortcut cave. Look out for a breakable wall as you climb a vertical space', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479017' },
      { name: 'Memory Locket 18', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Memorium', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479110' },
      { name: 'Memory Locket 19', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Farlands: Guarded by a void-powered Skarrgard.', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479196' },
      { name: 'Memory Locket 20', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Sands of Karak: Held by a corpse at the top of the area', parsingInfo: { type: 'flag', internalId: '' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479204' },
  ...
  },
{
  ...
  description: "Bosses",
  items: [
    { name: "Moss Mother", whichAct: 0, completionPercent: 0, prereqs: [], location: "Appearing in the Ruined Chapel at the end of Moss Grotto. ", parsingInfo: { type: "flag", internalId: "defeatedMossMother" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=476904" },
    { name: "Lace", whichAct: 0, completionPercent: 0, prereqs: [], location: "Encounter her at the entrance of deep docks.", parsingInfo: { type: "flag", internalId: "defeatedLace1" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=476915" },
    { name: "Bell Beast", whichAct: 0, completionPercent: 0, prereqs: [], location:"The Bell Beast can be found the very top of the Marrow " , parsingInfo: { type: "flag", internalId: "defeatedBellBeast" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477879" },
    { name: "Fourth Chorus", whichAct: 0, completionPercent: 0, prereqs: [], location: "Wakes up to fight you after receiving the Drifter's Cloak.", parsingInfo: { type: "flag", internalId: "defeatedSongGolem" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=477978"},
    { name: "Savage Beastfly", whichAct: 0, completionPercent: 0, prereqs: [], location: "Deep inside the Chapel of the Beast.", parsingInfo: { type: "flag", internalId: "???" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478019"},
    { name: "Skull Tyrant", whichAct: 0, completionPercent: 0, prereqs: [], location:"Skull Tyrant can be fought first in The Marrow(center dome)" , parsingInfo: { type: "flag", internalId: "skullKingDefeated" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478136"},
    { name: "Sister Splinter", whichAct: 0, completionPercent: 0, prereqs: [], location: "At north end of Shellwood", parsingInfo: { type: "flag", internalId: "defeatedSplinterQueen" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478137" },
    { name: "Widow", whichAct: 0, completionPercent: 0, prereqs: [], location: "Encountered in the room just north of Bellhart", parsingInfo: { type: "flag", internalId: "???" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478138"},
    { name: "Phantom", whichAct: 0, completionPercent: 0, prereqs: [], location: "In a room at the top of the Exhaust Organ, which acts as an alternative entrance to the Citadel, skipping the Last Judge boss.", parsingInfo: { type: "flag", internalId: "defeatedPhantom" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478370" },
    { name: "Moorwing", whichAct: 0, completionPercent: 0, prereqs: [], location: "3 rooms west of the Greymoor Bellway", parsingInfo: { type: "flag", internalId: "???" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478453"},
    { name: "Great Conchflies", whichAct: 0, completionPercent: 0, prereqs: [], location: "In the northwest section of the Blasted Steps, Hornet encounters a room filled with pinkish conch shells.", parsingInfo: { type: "flag", internalId: "???" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478506" },
    { name: "Last Judge", whichAct: 0, completionPercent: 0, prereqs: [], location: "Ring all five bells and play the Needolin in front of the door to begin the fight. If it's proving difficult, you can skip it by fighting Phantom instead.", parsingInfo: { type: "flag", internalId: "defeatedLastJudge" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478545"},
    { name: "Cogwork Dancers", whichAct: 0, completionPercent: 0, prereqs: [], location: "Cogwork Dancers are fought in the central area of Cogwork Core.", parsingInfo: { type: "flag", internalId: "defeatedCogworkDancers" }, mapLink:"https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478606" },
    { name: "Trobbio", whichAct: 0, completionPercent: 0, prereqs: [], location: "Encountered at The Stage after traversing through the Whispering Vaults", parsingInfo: { type: "flag", internalId: "defeatedTrobbio" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=480343" },
    { name: "Forebrothers Signis & Gron", whichAct: 0, completionPercent: 0, prereqs: [], location: "In an earlier room in the Deep Docks.", parsingInfo: { type: "flag", internalId: "defeatedSignisAndGron" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478831" },
    { name: "Groal the Great", whichAct: 0, completionPercent: 0, prereqs: [], location: "The Unravelled is a hidden boss found at the top of Whiteward, at the bottom of a disposal pit locked by the Surgeon's Key.", parsingInfo: { type: "flag", internalId: "defeatedGroalTheGreat" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478861"},
    { name: "The Unravelled", whichAct: 0, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedTheUnravelled" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478926" },
    { name: "Disgraced Chef Lugoli", whichAct: 0, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedDisgracedChefLugoli" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478992"},
    { name: "First Sinner", whichAct: 0, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedFirstSinner" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479023" },
    { name: "Craggler", whichAct: 0, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedCraggler" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478088"},
    { name: "Father of the Flame", whichAct: 0, completionPercent: 0, prereqs: [], location: "Far left corner of Wisp Thicket", parsingInfo: { type: "flag", internalId: "defeatedFatherOfTheFlame" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479155" },
    { name: "Skarrsinger Karmelita", whichAct: 0, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedAntQueen" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479198" },
    { name: "Voltvyrm", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedVoltvyrm" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479223"},
    { name: "Raging Conchfly", whichAct: 0, completionPercent: 0, prereqs: [], location:"" , parsingInfo: { type: "flag", internalId: "defeatedRagingConchfly" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479227"},
    { name: "Second Sentinel", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedSecondSentinel" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479253"},
    { name: "Broodmother", whichAct: 0, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedBroodmother" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479255"},
    { name: "Bell Eater", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedBellEater" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479264"},
    { name: "Plasmified Zango", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedPlasmifiedZango" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479273" },
    { name: "Tormented Trobbio", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedTormentedTrobbio" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479377"},
    { name: "Crust King Khann", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedCoralKing" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479392" },
    { name: "Shrine Guardian Seth", whichAct: 3, completionPercent: 0, prereqs: [], location:"" , parsingInfo: { type: "flag", internalId: "defeatedSeth" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=480352" },
    { name: "Nyleth", whichAct: 3, completionPercent: 0, prereqs: [], location:"" , parsingInfo: { type: "flag", internalId: "defeatedNyleth" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479404" },
    { name: "Palestag", whichAct: 3, completionPercent: 0, prereqs: [], location:"" , parsingInfo: { type: "flag", internalId: "defeatedPalestag" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479408"},
    { name: "Clover Dancers", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedCloverDancers" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479427" },
    { name: "Lost Garmond", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedLostGarmond" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479452" },
    { name: "Pinstress", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedPinstress" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479464"},
    { name: "Gurr the Outcast", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedGurrTheOutcast" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479467"},
    { name: "Lost Lace", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedLostLace" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479471"},
    { name: "Watcher at the Edge", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedWatcherAtTheEdge" }, mapLink: "" },
    { name: "Crawfather", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedCrawfather" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479740"},
    { name: "Summoned Saviour", whichAct: 3, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedSummonedSaviour" }, mapLink:  "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479494"},
    { name: "Shakra", whichAct: 2, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedShakra" }, mapLink: "" },
    { name: "Garmond and Zaza", whichAct: 2, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedGarmondAndZaza" }, mapLink: "" },
    { name: "Grand Mother Silk", whichAct: 0, completionPercent: 0, prereqs: [], location: "", parsingInfo: { type: "flag", internalId: "defeatedGrandMotherSilk" }, mapLink: "https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479099" }
  ]
}
];
