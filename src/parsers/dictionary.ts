...
export const CATEGORIES: CollectableCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Garmond and Zaza',           whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'garmondLibraryDefeatedHornet' }, mapLink: '' },
      ...
      { name: 'The Unravelled',             whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'wardBossDefeated' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478926' },
      { name: 'Disgraced Chef Lugoli',      whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedRoachkeeperChef' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478992'},
      { name: 'Father of the Flame',        whichAct: 2, completionPercent: 0, prereqs: ['Faydown Cloak'], location: 'Far left corner of Wisp Thicket', parsingInfo: { type: 'flag', internalId: 'defeatedWispPyreEffigy' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479155' },
      { name: 'Groal the Great',            whichAct: 2, completionPercent: 0, prereqs: [], location: 'The Unravelled is a hidden boss found at the top of Whiteward, at the bottom of a disposal pit locked by the Surgeon\'s Key.', parsingInfo: { type: 'flag', internalId: 'DefeatedSwampShaman' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478861'},
      { name: 'Craggler',                   whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'roofCrabDefeated' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478088'},
      { name: 'Voltvyrm',                   whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedZapCoreEnemy' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479223'},
      { name: 'Raging Conchfly',            whichAct: 2, completionPercent: 0, prereqs: [], location: '' , parsingInfo: { type: 'flag', internalId: 'defeatedCoralDrillerSolo' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479227'},
      { name: 'First Sinner',               whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedFirstWeaver' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479023' },
      ...
      { name: 'Second Sentinel',            whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: '???' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479253'},
      ...
      { name: 'Plasmified Zango',           whichAct: 3, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'BlueScientistInfectedMet' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479273' },
      { name: 'Watcher at the Edge',        whichAct: 3, completionPercent: 0, prereqs: ['Silk Soar'], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedGreyWarrior' }, mapLink: '' },
      ...
      { name: 'Gurr the Outcast',           whichAct: 3, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: '???' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479467'},
      ...
      { name: 'Pinstress',                  whichAct: 3, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'PinstressPeakBattleAccepted' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479464'},
      ...
      { name: 'Nyleth',                     whichAct: 3, completionPercent: 0, prereqs: [], location: '' , parsingInfo: { type: 'flag', internalId: 'defeatedFlowerQueen' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479404' },
