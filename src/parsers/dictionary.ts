...
export const CATEGORIES: CollectableCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Garmond and Zaza',           whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'garmondLibraryDefeatedHornet' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479361' },
      ...
      { name: 'Watcher at the Edge',        whichAct: 3, completionPercent: 0, prereqs: ['Silk Soar'], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedGreyWarrior' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479494' },
      ...
      { name: 'Gurr the Outcast',           whichAct: 3, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedAntTrapper' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479467'},
