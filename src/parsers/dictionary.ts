...
export const CATEGORIES: CollectableCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Vesticrest 1', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Unlock 4 Crests and talk to Eva: + 1 yellow tool slot on all crests', parsingInfo: { type: 'flag', internalId: 'UnlockedExtraYellowSlot' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479653' },
      { name: 'Vesticrest 2', whichAct: 0, completionPercent: 0, prereqs: [], location: 'Use 9 Memory Lockets and talk to Eva: + 1 blue tool slot on all crests', parsingInfo: { type: 'flag', internalId: 'UnlockedExtraBlueSlot' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479653' },
