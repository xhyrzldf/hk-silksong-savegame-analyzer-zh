...
export const CATEGORIES: CollectableCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Grand Mother Silk',          whichAct: 2, completionPercent: 0, prereqs: [], location: 'Can be found above cogwork core in The Cradle.', parsingInfo: { type: 'journal', internalId: ['Silk Boss'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479099' },
      ...
      { name: 'Palestag',                   whichAct: 3, completionPercent: 0, prereqs: [], location: 'Can be found in Lost Verdania' , parsingInfo: { type: 'flag', internalId: 'defeatedPalestag' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479408'},
