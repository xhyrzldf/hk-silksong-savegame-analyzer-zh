...
export const CATEGORIES: CollectableCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Savage Beastfly',            whichAct: 1, completionPercent: 0, prereqs: [], location: 'Deep inside the Chapel of the Beast.', parsingInfo: { type: 'flag', internalId: '???' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478019'},
      ...
      { name: 'Moorwing',                   whichAct: 1, completionPercent: 0, prereqs: [], location: '3 rooms west of the Greymoor Bellway', parsingInfo: { type: 'flag', internalId: '???' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478453'},
      { name: 'Widow',                      whichAct: 1, completionPercent: 0, prereqs: [], location: 'Encountered in the room just north of Bellhart', parsingInfo: { type: 'flag', internalId: '???' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478138'},
      { name: 'Great Conchflies',           whichAct: 1, completionPercent: 0, prereqs: [], location: 'In the northwest section of the Blasted Steps, Hornet encounters a room filled with pinkish conch shells.', parsingInfo: { type: 'flag', internalId: '???' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478506' },
      ...
      { name: 'Forebrothers Signis & Gron', whichAct: 2, completionPercent: 0, prereqs: [], location: 'In an earlier room in the Deep Docks.', parsingInfo: { type: 'flag', internalId: 'defeatedSignisAndGron' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478831' },
      { name: 'The Unravelled',             whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedTheUnravelled' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478926' },
      { name: 'Disgraced Chef Lugoli',      whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedDisgracedChefLugoli' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478992'},
      { name: 'Father of the Flame',        whichAct: 2, completionPercent: 0, prereqs: ['Faydown Cloak'], location: 'Far left corner of Wisp Thicket', parsingInfo: { type: 'flag', internalId: 'defeatedFatherOfTheFlame' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479155' },
      { name: 'Groal the Great',            whichAct: 2, completionPercent: 0, prereqs: [], location: 'The Unravelled is a hidden boss found at the top of Whiteward, at the bottom of a disposal pit locked by the Surgeon\'s Key.', parsingInfo: { type: 'flag', internalId: 'defeatedGroalTheGreat' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478861'},
      { name: 'Craggler',                   whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedCraggler' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=478088'},
      { name: 'Voltvyrm',                   whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedVoltvyrm' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479223'},
      { name: 'Raging Conchfly',            whichAct: 2, completionPercent: 0, prereqs: [], location: '' , parsingInfo: { type: 'flag', internalId: 'defeatedRagingConchfly' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479227'},
      { name: 'First Sinner',               whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedFirstSinner' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479023' },
      ...
      { name: 'Second Sentinel',            whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedSecondSentinel' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479253'},
      { name: 'Shakra',                     whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedShakra' }, mapLink: '' },
      { name: 'Grand Mother Silk',          whichAct: 2, completionPercent: 0, prereqs: [], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedGrandMotherSilk' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479099' },
      ...
      { name: 'Watcher at the Edge',        whichAct: 3, completionPercent: 0, prereqs: ['Silk Soar'], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedWatcherAtTheEdge' }, mapLink: '' },
      ...
      { name: 'Shrine Guardian Seth',       whichAct: 3, completionPercent: 0, prereqs: ['Silk Soar'], location: '' , parsingInfo: { type: 'flag', internalId: 'defeatedSeth' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=480352' },
      ...
      { name: 'Skarrsinger Karmelita',      whichAct: 3, completionPercent: 0, prereqs: ['Elegy Of The Deep'], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedAntQueen' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479198' },
      { name: 'Crust King Khann',           whichAct: 3, completionPercent: 0, prereqs: ['Elegy Of The Deep'], location: '', parsingInfo: { type: 'flag', internalId: 'defeatedCoralKing' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479392' },
