...
export const CATEGORIES: CollectableCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Garmond and Zaza',           whichAct: 2, completionPercent: 0, prereqs: [], location: 'South east part of Songclave, Only available in Act 2.', parsingInfo: { type: 'flag', internalId: 'garmondLibraryDefeatedHornet' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479361' },
      ...
      { name: 'Grand Mother Silk',          whichAct: 2, completionPercent: 0, prereqs: [], location: 'Can be found above cogwork core in The Cradle.', killsRequired: 1 ,parsingInfo: { type: 'journal', internalId: ['Silk Boss'] }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479099' },
      ...
      { name: 'Plasmified Zango',           whichAct: 3, completionPercent: 0, prereqs: [], location: 'Can be found in a secret room within western Wormways during Act 3', parsingInfo: { type: 'flag', internalId: 'BlueScientistInfectedMet' }, mapLink: 'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479273' },
      ...
      { name: 'Summoned Saviour',           whichAct: 3, completionPercent: 0, prereqs: [], location: 'Can be found in the extreme bottom left of Bonegrave behind a breakable wall, a sub area of Moss Grotto.', parsingInfo: { type: 'flag', internalId: 'EncounteredSummonedSaviour' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479494'},
      { name: 'Lost Lace',                  whichAct: 3, completionPercent: 0, prereqs: [], location: 'Located in The Abyss, under the vast Void Ocean that lies within.', parsingInfo: { type: 'flag', internalId: 'EncounteredLostLace' }, mapLink:  'https://mapgenie.io/hollow-knight-silksong/maps/pharloom?locationIds=479471'},
    ]
  },
  {
    name: 'Keys',
  ...
  },
  {
    ...
    items: [
      {name: 'Mossgrub',                    killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: ['MossBone Crawler']}, mapLink: ''},
      {name: 'Massive Mossgrub',            killsRequired: 3,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: ['MossBone Crawler Fat']}, mapLink: ''},
      {name: 'Mossmir',                     killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: ['MossBone Fly']}, mapLink: ''},
      {name: 'Moss Mother',                 killsRequired: 3,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Aknid',                       killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Skull Scuttler',              killsRequired: 35, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Skullwing',                   killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Skull Brute',                 killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Skull Tyrant',                killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Kilik',                       killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Beastfly',                    killsRequired: 30, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Savage Beastfly',             killsRequired: 2,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Caranid',                     killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Vicious Caranid',             killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Hardbone Hopper',             killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Hardbone Elder',              killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Tarmite',                     killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Mawling',                     killsRequired: 30, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Marrowmaw',                   killsRequired: 8,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Hoker',                       killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Flintbeetle',                 killsRequired: 3,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Rhinogrund',                  killsRequired: 2,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Gromling',                    killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Grom',                        killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Bell Beast',                  killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pilgrim Groveller',           killsRequired: 35, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pilgrim Pouncer',             killsRequired: 35, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []},  mapLink: ''},
      {name: 'Pilgrim Hornfly',             killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pilgrim Hulk',                killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pilgrim Bellbearer',          killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Winged Pilgrim',              killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Elder Pilgrim',               killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Winged Pilgrim Bellbearer',   killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pilgrim Hiker',               killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pilgrim Guide',               killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Overgrown Pilgrim',           killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Covetous Pilgrim',            killsRequired: 2,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Snitchfly',                   killsRequired: 4,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Lavalug',                     killsRequired: 12, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Lavalarga',                   killsRequired: 8,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Smelt Shoveller',             killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Flintstone Flyer',            killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Flintflame Flyer',            killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Smokerock Sifter',            killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Deep Diver',                  killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Forebrothers Signis & Gron',  killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Cragglite',                   killsRequired: 3,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Craggler',                    killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Brushflit',                   killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Fertid',                      killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Flapping Fertid',             killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Fourth Chorus',               killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Skarrlid',                    killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Skarrwing',                   killsRequired: 30, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Skarr Scout',                 killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Skarr Stalker',               killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Spear Skarr',                 killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Skarrgard',                   killsRequired: 2,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Gurr the Outcast',            killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Last Claw',                   killsRequired: 6,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Skarrsinger Karmelita',       killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Mite',                        killsRequired: 30, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Fluttermite',                 killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Mitemother',                  killsRequired: 10,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Dreg Catcher',                killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Silk Snipper',                killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Thread Raker',                killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Moorwing',                    killsRequired: 1, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Wisp',                        killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Burning Bug',                 killsRequired: 8, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Father of the Flame',         killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Craw',                        killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Tallcraw',                    killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Squatcraw',                   killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Craw Juror',                  killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Tallcraw Juror',              killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Squatcraw Juror',             killsRequired: 8, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Crawfather',                  killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Muckmaggot',                  killsRequired: 80, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Slubberlug',                  killsRequired: 12, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Muckroach',                   killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Bloatroach',                  killsRequired: 12, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Roachcatcher',                killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Roachfeeder',                 killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Roachkeeper',                 killsRequired: 10,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Roachserver',                 killsRequired: 10,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Disgraced Chef Lugoli',       killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Wraith',                      killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Mothleaf Lagnia',             killsRequired: 25,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Miremite',                    killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Swamp Squit',                 killsRequired: 30, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Spit Squit',                  killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Stilkin',                     killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Stilkin Trapper',             killsRequired: 12, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Groal the Great',             killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Barnak',                      killsRequired: 18, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Ductsucker',                  killsRequired: 6, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pond Skipper',                killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pondcatcher',                 killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Shellwood Gnat',              killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Wood Wasp',                   killsRequired: 12, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Splinter',                    killsRequired: 12, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Splinterhorn',                killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Splinterbark',                killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Sister Splinter',             killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Phacia',                      killsRequired: 25,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pollenica',                   killsRequired: 10,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Gahlia',                      killsRequired: 20,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Shrine Guardian Seth',        killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Nyleth',                      killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Furm',                        killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Winged Furm',                 killsRequired: 12, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pharlid',                     killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pharlid Diver',               killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Shardillard',                 killsRequired: 3, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Sandcarver',                  killsRequired: 40, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Squirrm',                     killsRequired: 4, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Judge',                       killsRequired: 15,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Last Judge',                  killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Coral Furm',                  killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Driznit',                     killsRequired: 25, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Driznarga',                   killsRequired: 14, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pokenabbin',                  killsRequired: 16, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Conchfly',                    killsRequired: 8, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Great Conchfly',              killsRequired: 2,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Crustcrawler',                killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Crustcrag',                   killsRequired: 6, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Kai',                         killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Spinebeak Kai',               killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Steelspine Kai',              killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Yuma',                        killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Yumama',                      killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Karaka',                      killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Kakri',                       killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Yago',                        killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Karak Gor',                   killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Alita',                       killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Corrcrust Karaka',            killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Crust King Khann',            killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Watcher at the Edge',         killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Voltvyrm',                    killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Drapefly',                    killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Drapelord',                   killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Drapemite',                   killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Giant Drapemite',             killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Underworker',                 killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Underscrub',                  killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Undersweep',                  killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Underpoke',                   killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Underloft',                   killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Undercrank',                  killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Envoy',                       killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Choir Pouncer',               killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Choir Hornhead',              killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Choir Bellbearer',            killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Choir Flyer',                 killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Choir Elder',                 killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Choristor',                   killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Reed',                        killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Grand Reed',                  killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Choir Clapper',               killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Clawmaiden',                  killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Memoria',                     killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Minister',                    killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Maestro',                     killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Second Sentinel',             killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Dreg Husk',                   killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Dregwheel',                   killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Surgeon',                     killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Mortician',                   killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'The Unravelled',              killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Cogwork Underfly',            killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Cogwork Hauler',              killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Cogwork Crawler',             killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Cogworker',                   killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Cogwork Spine',               killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Cogwork Choirbug',            killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Cogwork Cleanser',            killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Cogwork Defender',            killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Cogwork Clapper',             killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Cogwork Dancers',             killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Vaultborn',                   killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Lampbearer',                  killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Scrollreader',                killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Vaultkeeper',                 killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Trobbio',                     killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Tormented Trobbio',           killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Penitent',                    killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Puny Penitent',               killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Freshfly',                    killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Scabfly',                     killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Guardfly',                    killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Wardenfly',                   killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Broodmother',                 killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Driftlin',                    killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Mnemonid',                    killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Mnemonord',                   killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Servitor Ignim',              killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Servitor Boran',              killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Winged Lifeseed',             killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Plasmid',                     killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Plasmidas',                   killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Plasmified Zango',            killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Leaf Glider',                 killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Leaf Roller',                 killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pendra',                      killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pendragor',                   killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Nuphar',                      killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Cloverstag',                  killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Palestag',                    killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Kindanir',                    killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Verdanir',                    killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Escalion',                    killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Clover Dancers',              killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Shadow Creeper (Silksong)',   killsRequired: 20, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Shadow Charger',              killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Gloomsac',                    killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Gargant Gloom',               killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Void Tendrils (Silksong)',    killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Void Mass',                   killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Summoned Saviour',            killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Wingmould (Silksong)',        killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Garpid',                      killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Imoba',                       killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Skrill',                      killsRequired: 15, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Bell Eater',                  killsRequired: 5,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Huge Flea',                   killsRequired: 10, whichAct: 0, completionPercent: 0, prereqs: [],   location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Shakra',                      killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Garmond & Zaza',              killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Lost Garmond',                killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Pinstress',                   killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Widow',                       killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'First Sinner',                killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Phantom',                     killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Lace',                        killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Grand Mother Silk',           killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''},
      {name: 'Lost Lace',                   killsRequired: 1,  whichAct: 0, completionPercent: 0, prereqs: [],  location: '', parsingInfo: {type: 'journal', internalId: []}, mapLink: ''}
    ]
  }
];
...
export function isItemUnlockedInPlayerSave(itemParsingInfo: ParsingInfo, saveData: any): { unlocked: boolean, returnValue?: number } {
  ...
  const typeHandlers = {
    ...
    journal: (entryNames: string[]) => {
      ...
      return { returnValue: killsAchieved };
    },
